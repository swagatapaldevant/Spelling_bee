...
class AllBengaliVowelScreen extends StatefulWidget {
  const AllBengaliVowelScreen({super.key});

  @override
  State<AllBengaliVowelScreen> createState() => _AllBengaliVowelScreenState();
}

class _AllBengaliVowelScreenState extends State<AllBengaliVowelScreen> {

  final ExplorePlayUsecase _explorePlayUsecase = getIt<ExplorePlayUsecase>();
  final SharedPref _pref = getIt<SharedPref>();
  List<AlphabetListModel> alphabetDataList = [];
  List<String> allVowelList = [];
  ...
  Widget build(BuildContext context) {
    ...
    return
      Scaffold(
        ...
        body: Stack(
          children: [
            Image.asset("assets/images/alphabet/alphabet_details_bg.jpeg",
            ...
            Container(
              ...
              child: SafeArea(
                child: Padding(
                  ...
                  ):allVowelList.isEmpty?

                  Center(
                    child: Text("Now no vowels are updated ", style: TextStyle(
                            ...
                            children: [
                              ...
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final letter =allVowelList[index];
                                  return Bounceable(
                                    onTap: () {
                                      Navigator.pushNamed(
                                        context,
                                        ...
                                        arguments:{
                                          "index": index,
                                          "letterList":allVowelList, // Excludes section headers
                                        },
                                      );
                                    },
                                    child: Container(
...
vowelList() async {
  ...
  String? vowelId = await _pref.getVowelId();
  Map<String, dynamic> requestData = {

  };
  Resource resource =
  await _explorePlayUsecase.bengaliAlphabetList(requestData: requestData, id: vowelId);
  if (resource.status == STATUS.SUCCESS) {
    ...
    for (var item in alphabetDataList) {
      allVowelList.add(item.learningDetailsName.toString());
    }
