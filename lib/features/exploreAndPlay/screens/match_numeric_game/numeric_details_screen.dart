...
class NumericDetailsScreen extends StatefulWidget {
  final int initialIndex;
  final List<String> letterList;
  const NumericDetailsScreen({super.key, required this.initialIndex, required this.letterList});

  @override
  State<NumericDetailsScreen> createState() => _NumericDetailsScreenState();
}

class _NumericDetailsScreenState extends State<NumericDetailsScreen> {
