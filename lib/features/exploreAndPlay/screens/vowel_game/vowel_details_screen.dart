...
class VowelDetailsScreen extends StatefulWidget {
  final int initialIndex;
  final List<String> letterList;

  const VowelDetailsScreen(
      {super.key, required this.initialIndex, required this.letterList});

  @override
  State<VowelDetailsScreen> createState() => _VowelDetailsScreenState();
}

class _VowelDetailsScreenState extends State<VowelDetailsScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                          ...
                          Positioned(
                            ...
                            child: Bounceable(
                              ...
                              child: Image.asset(
                                ...
                                height:
                                    ScreenUtils().screenHeight(context) * 0.06,
                      ...
                      Visibility(
                        visible: currentIndex + 1 == widget.letterList.length
                            ? true
                            : false,
                        child: CommonButton(
                          onTap: () {
...
class BackIconWidget extends StatelessWidget {
  Function()? onTap;
  final IconData icon;
  BackIconWidget({super.key, this.onTap, required this.icon});
      ...
      child: Container(
        ...
        child: Padding(
          padding: EdgeInsets.symmetric(
              horizontal: ScreenUtils().screenHeight(context) * 0.02,
              vertical: ScreenUtils().screenHeight(context) * 0.01),
          child: Icon(icon,
              size: 40, color: AppColors.dashboardContainerBackgroundColor),
        ),
      ),
    );
  }
